<template>
  <div>
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
      <div>
        <h4 class="mb-3 mb-md-0">Dastur Afzalliklari</h4>
      </div>
      <div class="d-flex align-items-center flex-wrap text-nowrap">
        <button
          type="button"
          class="btn btn-primary btn-icon-text mb-2 mb-md-0"
          data-toggle="modal" data-target="#createService"
        >
          <i
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-description">
                Saytda mavjud Dastur afzalliklari bo'limini o'zgartirish imkoni mavjud.
            </p>
                    ...
                    <table class="table table-bordered" v-if="!loader && formats.length > 0">
                      ...
                      <tbody>
                        <tr v-for="(format, index) in formats.filter((f) => { 
                          ...
                          <td><img :src="format.icon" width="50" height="50"/></td>
                          <td>{{ format.title }}</td>
    ...
    <Create modalKey="createService" :fetch="fetchSyn" :languages="languages" />
  </div>
</template>
...
export default {
    ...
    methods: {
        ...
        async fetchSyn () {
            ...
            this.formats = this.$store.getters.services
            this.loader = false
        },
        async deleteSyn (id) {
