...
<div class="modal fade" :id="modalKey" tabindex="-1" role="dialog" :aria-labelledby="`${modalKey}1`" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form @submit.prevent="handleUpdateTitle">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="block" ref="block">
                    <option v-for="block in 13" :key="block" :value="block" :selected="data.block === block">
                        {{ block }}
                    </option>
                </select>
            </div>
...
export default {
    ...
    methods: {
        async handleUpdateTitle () {
            ...
            await this.$store.dispatch('updateTitle',form)
